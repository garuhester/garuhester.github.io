...
var WewinPrintService = function () {
    ...
    WewinPrintService.prototype.CreateView = function () {
        ...
        html += "        <\/div>";
        html += "        <div class=\"btns\">";
        html += "            <button class=\"btn\" type=\"button\" name=\"print\" onclick=\"Print()\">";
        html += "                打印";
        html += "            <\/button>";
        html += "            <button class=\"btn\" type=\"button\" name=\"print\" onclick=\"lookXml()\">";
        html += "                查看报文";
        html += "            <\/button>";
        html += "            <button class=\"btn\" type=\"button\" name=\"print\" onclick=\"lookHelp()\">";
        html += "                帮助";
        html += "            <\/button>";
        html += "            <button class=\"btn\" type=\"button\" name=\"close\" onclick=\"closeWindows()\">";
        html += "                关闭";
        html += "            <\/button>";
        html += "        <\/div>";
        html += "        <div class=\"split2\"><\/div>";
        html += "        <div class=\"tags\">";
        ...
        html += "            <\/div>";
        html += "            <div class=\"right\">";
        html += "                <a href=\".\/wewin打印服务插件_20190122.rar\" target=\"_blank\">wewin打印服务插件下载<\/a>";
        html += "            <\/div>";
        html += "        <\/div>";
