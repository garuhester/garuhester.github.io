...
function ViewPrint(data, temp) {
    ...
    for (var i = 0; i < data.length; i++) {
        ...
        //修改版本号
        document.getElementById("versionnum").innerHTML = "123";
        ...
        if (labelType[0] == "123") {
            ...
            if(selValue == 0){
                ...
                if(i == 0){
                    text += "<div style=\"position: relative;background-image:url(\'labelimage\/(25-25)(0).png\');background-repeat:no-repeat;width: 200px;height: 200px;display:block;margin:0 auto;padding:0;\">";
                } else {
                    text += "<div style=\"position: relative;background-image:url(\'labelimage\/(25-25)(0).png\');background-repeat:no-repeat;width: 200px;height: 200px;display:block;margin:0 auto;padding:0;margin-top: 15px\">";
                }
